...
import static org.application.CalendarOptionSelect.calyearScanner;
...
public class CircuitOptionSelect {
    ...
    static void getCircuitsList() throws IOException, InterruptedException {
        try {// System prompt for user input for championship year
            ...
            circScanner.nextLine(); // Consume the invalid input
